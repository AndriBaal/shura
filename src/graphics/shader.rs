...
impl Shader {
    ...
    pub const COLORED_SPRITE_GLSL: &'static str = include_str!("../../res/shader/colored_sprite.glsl");
    ...
    pub const TRANSPARENT_SPRITE_WGSL: &'static str = include_str!("../../res/shader/transparent_sprite.wgsl");
