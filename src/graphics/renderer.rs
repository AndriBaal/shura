...
impl<'a> Renderer<'a> {
    pub(crate) fn new(
        ...
        let camera = match config.camera {
            ...
            RenderCamera::RelativeCameraBottomLeft => &config.defaults.relative_camera_bottom_left,
            RenderCamera::RelativeCameraBottomRight => &config.defaults.relative_camera_bottom_right,
            RenderCamera::RelativeCameraTopLeft => &config.defaults.relative_camera_top_left,
            RenderCamera::RelativeCameraTopRight => &config.defaults.relative_camera_top_right,
        };
